...
function formatPrice(service: PaintingService): string {
  if (!service.price) return "Contact for price";
  // Painting services always show fixed price
  return `₹${service.price}`;
}

export default function PaintingServiceCard({ service, onBookNow }: PaintingServiceCardProps) {
